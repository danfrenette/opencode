...
export const dict = {
  ...
  "session.permission.preview.unavailable": "A preview isn't available for this edit. You can still allow or deny it.",
  "session.permission.preview.fileSelector": "Preview file",
  "session.permission.preview.region": "Edit preview",
  "session.permission.preview.reviewChanges": "Review changes",
  "session.permission.preview.closeReview": "Close review",
  "session.permission.preview.reviewTitle": "Pending changes",
  "session.permission.preview.file.added": "{{file}} Added +{{additions}} -{{deletions}}",
  "session.permission.preview.file.deleted": "{{file}} Deleted +{{additions}} -{{deletions}}",
  "session.permission.preview.file.modified": "{{file}} Modified +{{additions}} -{{deletions}}",
