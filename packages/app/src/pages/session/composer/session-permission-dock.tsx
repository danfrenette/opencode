...
export type PermissionDecision = "once" | "always" | "reject" | "rejectWithReason"

export function SessionPermissionDock(props: {
  request: PermissionRequest
  responding: boolean
  onDecide: (response: Exclude<PermissionDecision, "rejectWithReason">, message?: string) => void
  ...
  const editPermission = () => props.request.permission === "edit"

  // Show file summary for edit permissions with metadata
