...
export function SessionHeaderMobile(props: SessionHeaderMobileProps) {
  ...
  const pendingApprovalMode = () => !!props.pendingApproval && isReviewMode()
      ...
      {pendingApprovalMode() ? (
        <>
          <div class="min-w-0 flex-1 px-3 text-center">
            <div class="text-14-medium text-text-strong truncate">{language.t("ui.sessionReview.title.pendingApproval")}</div>
          </div>
          <div class="flex items-center gap-1">
            ...
            />
            <Button variant="ghost" size="small" class="h-11 px-3 rounded-md" onClick={props.onPendingApprovalBack}>
        ...
        <>
          <div class="flex items-center gap-1">
            ...
            >
              ...
              />
              <span class="text-14-medium text-text-strong">{language.t("session.fileTree.label")}</span>
            </Button>
            ...
            >
              <Icon size="small" name={isReviewMode() ? "speech-bubble" : "review"} class="text-icon-base" />
